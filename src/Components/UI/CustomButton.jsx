...
const CustomButton = ({text}) => {
  return (
    ...
    <div className="relative h-[50px] gap-2 flex items-center bg-[#d1ddff] rounded-[30px] transform hover:scale-105 transition duration-300">
        ...
        <span className="text-[495eb3] text-lg font-bold pr-[20px]">{text}</span>
    </div>
